...
export default function participantsController({ participantService, fetchConnectedParticipants } = {}) {
  ...
  router.get('/', async (req, res) => {
    ...
    try {
      const docs = await fetchConnectedParticipants(classId, { includeDisconnected })
