    ...
    <div className="fixed inset-0 z-90 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-white rounded-2xl p-8 max-w-4xl w-full text-center shadow-2xl">
            ...
            winners.map((p, i) => (
              <div
                ...
                className={`p-6 rounded-lg text-center shadow-lg transform ${
                  i === 0 ? 'scale-110 bg-gradient-to-br from-yellow-300 to-yellow-400' : i === 1 ? 'bg-gray-200' : 'bg-yellow-100'
                }`}
                style={{ width: 200 }}
              >
        ...
        <div className="flex justify-center gap-4">
          ...
          <Button onClick={onRestart} variant="ghost">Reiniciar juego</Button>
        </div>
      </div>
    </div>
  );
