...
export function DashboardHeader({ classData, onDelete, onRestartGame, onExit, onShowCode }) {
  ...
  <Button onClick={() => onShowCode && onShowCode(classData.code || classData.id)} variant="outline">Mostrar código</Button>
