...
export default function ClassJoin({ onJoined, onClose }) {
  ...
  async function handleJoin() {
    try {
      ...
      if (onJoined)
        onJoined({ classCode: code.trim().toUpperCase(), participant: p });
    } catch (e) {
      ...
      <FancyCard>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="Nombre que verán el profe"
          />
          <Input
            label="Contraseña (si la clase la tiene)"
            value={password}
